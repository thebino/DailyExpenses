...
interface DailyExpensesRepository {
    ...
    suspend fun addNewExpense(instance: String, id: String, category: String, expenseDate: String, creationDate: String, updatedDate: String?, description: String, amount: Float): Expense?
